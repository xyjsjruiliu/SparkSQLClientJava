...
import com.xy.lr.tics.spark.sql.properties.StatusOfJson;
import com.xy.lr.tics.spark.sql.properties.StatusOfJsonEnum;
import com.xy.lr.tics.spark.sql.properties.TICSInfoJava;
...
public class SparkSQLClientJava {
    ...
    //默认构造函数
    public SparkSQLClientJava(){
        //配置文件
        TICSInfoJava ticsInfo = new TICSInfoJava("conf/TICSInfo.properties");
        //连接SparkSQLServer
    ...
    public static void main(String[] args){
        ...
        SparkSQLClientJava ssql = new SparkSQLClientJava();
        ssql.DelSuspectedCar("11");
    }
}